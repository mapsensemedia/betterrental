...
export default function CarRentalTipsNewDrivers() {
  useEffect(() => {
    document.title = "Car Rental Tips for New & Young Drivers in BC – C2C Rental";
    ...
    script.id = "blog-tips-new-drivers-jsonld";
    script.type = "application/ld+json";
    script.textContent = JSON.stringify(schema);
    document.head.appendChild(script);

    return () => { canonical?.remove(); document.getElementById("blog-tips-new-drivers-jsonld")?.remove(); };
  }, []);
