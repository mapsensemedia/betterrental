...
import { ArrowLeft, Loader2, Check, Car, User, Calendar } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { data: booking, error } = await supabase
        ...
        .insert([{
          user_id: user.id,
          vehicle_id: formData.categoryId, // Using category ID as vehicle reference
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Quick booking for on-site customers
            </p>
          </div>
        </div>
