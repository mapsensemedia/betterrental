...
export function ReturnBookingSummary({ booking, isException }: ReturnBookingSummaryProps) {
  ...
  const isOverdue = new Date(booking.end_at) < new Date() && booking.status === "active";
        ...
        <Card className="border-destructive/50 bg-destructive/5">
          <CardContent className="py-3">
            <div className="flex items-center gap-2 text-destructive">
              ...
              <span className="text-sm font-medium">Overdue Return</span>
            </div>
          </CardContent>
        </Card>
      )}
        ...
        <CardContent className="space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className={isOverdue ? "text-destructive font-medium" : ""}>
              {format(new Date(booking.end_at), "PPp")}
            </span>
          </div>
          <div className="flex justify-between">
