...
export const PRICE_TOOLTIPS = {
  ...
  youngDriverFee: "A one-time $15 CAD fee applies for primary drivers aged 20–24.",
  youngDriverAdditional: "A one-time $15 CAD fee applies for each additional driver aged 20–24.",
