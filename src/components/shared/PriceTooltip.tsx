...
export const PRICE_TOOLTIPS = {
  ...
  youngDriverFee: "A $15 CAD/day fee applies for primary drivers aged 21–24, charged for every day of the rental.",
  youngDriverAdditional: "A $15 CAD/day fee applies for each additional driver aged 21–24, charged for every day of the rental.",
